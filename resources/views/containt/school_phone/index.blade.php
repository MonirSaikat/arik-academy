        ...
        <div class="col-lg-12">
          @if (userHasPermission('class-store'))
            <button type="button" class="btn btn-sm btn-primary mr-2 mb-3"  data-toggle="modal" data-target="#AddModel">
              <i class="fa fa-plus"></i> Add School Inormation
            </button>
          @endif
            <div class="card mb-4">
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a href="{{route('school.phone.edit',$data->id)}}" class="btn btn-warning">Edit</a>
                              ...
                              <a class="dropdown-item text-danger" href="{{ route('school.phone.delete',$data->id) }}" onclick="return confirm('Are you sure to delete this data..??')"><i class="fas fa-trash mr-2"></i>Delete</a>
                              @endif
                            </div>
                          </div>
                        </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('school.phone') }}" method="post">
            @csrf
            <div class="mb-3">
                <label for="school_name" class="form-label">School Name</label>
                 <input type="text" class="form-control @error('school_name') is-invalid @enderror" id="school_name" name="school_name" required>
              </div>
              <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="teacher" class="form-label">Total Teacher</label>
                 <input type="text" class="form-control @error('teacher') is-invalid @enderror" id="teacher" name="teacher" required>
              </div>
              <div class="mb-3">
                <label for="student" class="form-label">Total Student</label>
                 <input type="text" class="form-control @error('student') is-invalid @enderror" id="student" name="student" required>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="buliding" class="form-label">School Buliding</label>
                 <input type="text" class="form-control @error('buliding') is-invalid @enderror" id="buliding" name="buliding" required>
              </div>

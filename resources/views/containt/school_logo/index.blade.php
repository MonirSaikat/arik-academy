        ...
        <div class="col-lg-12">
          @if (userHasPermission('class-store'))
            <button type="button" class="btn btn-sm btn-primary mr-2 mb-3"  data-toggle="modal" data-target="#AddModel">
              <i class="fa fa-plus"></i> Add School Logo photo
            </button>
          @endif
            <div class="card mb-4">
                ...
                <table class="table align-items-center table-flush table-hover table-striped" id="dataTableHover">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{asset('uploads/logos/'.$logo->photo)}}" width="50px">
                        </td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item text-danger" href="{{ route('school.logo.delete',$logo->id) }}" onclick="return confirm('Are you sure to delete this data..??')"><i class="fas fa-trash mr-2"></i>Delete</a>
                              @endif
                            </div>
                          </div>
                        </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('school.log')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="mb-3">

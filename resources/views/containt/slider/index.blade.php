        ...
        <div class="col-lg-12">
          @if (userHasPermission('class-store'))
            <button type="button" class="btn btn-sm btn-primary mr-2 mb-3"  data-toggle="modal" data-target="#AddModel">
              <i class="fa fa-plus"></i> Add School slider photo
            </button>
          @endif
            <div class="card mb-4">
                ...
                <table class="table align-items-center table-flush table-hover table-striped" id="dataTableHover">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        {{-- <td>{{$slider->school_name}}</td> --}}
                        <td>
                            <img src="{{asset('uploads/sliders/'.$slider->photo)}}" width="50px">
                        </td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item text-danger" href="{{ route('school.slider.delete',$slider->id) }}" onclick="return confirm('Are you sure to delete this data..??')"><i class="fas fa-trash mr-2"></i>Delete</a>
                              @endif
                            </div>
                          </div>
                        </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add School slider photo</h5>
      ...
      <div class="modal-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            {{-- <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="photo" class="form-label">Worker Photo</label>

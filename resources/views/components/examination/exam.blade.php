                    ...
                    <tr>
                      ...
                      <td>
                        @if ($item->is_active == true)
                            <span class="bg-primary p-1 rounded text-light">Active</span>
                        @else
                            <span class="bg-warning p-1 rounded text-light">Deactive</span>
                        @endif
                      </td>
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            ...
                            <form action="{{ route('backend.exam.delete',$item->id) }}" method="post">
                                @csrf
                                @method('delete')
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('backend.exam.store') }}" method="post">
            @csrf
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('backend.exam.update') }}" method="POST">
          @csrf
          <div class="form-group">
...
@push('js')
    ...
    <script>
        ...
        function editbutton(Id){
            ...
            var url = '{{ Route("backend.exam.edit",":id") }}'

                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item text-danger" href="{{ route('backend.session.delete',$item->id) }}" onclick="return confirm('Are you sure to delete this data..??')"><i class="fas fa-trash mr-2"></i>Delete</a>
                            @endif
                          </div>
                        </div>
                      </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('backend.session.store') }}" method="post">
            @csrf
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('backend.session.update') }}" method="POST">
          @csrf
          <div class="form-group">
...
@push('js')
    ...
    <script>
        ...
        function editbutton(Id){
            ...
            var url = '{{ Route("backend.session.edit",":id") }}'

...
<section>
  <div class="container-fluid">
      <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus"></i>Inventory Category </button>
  </div>
<div class="card mt-3">
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item text-danger" href="{{route('backend.inventory_category.delete',$categorys->id)}}" onclick="return confirm('Are you sure to delete this data..??')"><i class="fas fa-trash mr-2"></i>Delete</a>
                        @endif
                      </div>
                    </div>
                  </td> 
...
<div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      <form action="{{route('backend.inventory_category.store')}}" method="post">
        @csrf
      <div class="modal-header">
        <h5 id="exampleModalLabel" class="modal-title">Add Inventory category</h5>
...
<div role="document" class="modal-dialog">
  ...
  <div class="modal-content">
     <form action="{{route('backend.inventory_category.update')}}" method="post">
      @csrf
      <div class="modal-header">
...
function editbutton(Id){
  ...
  var url ='{{route("backend.inventory_category.edit", ":id")}}'

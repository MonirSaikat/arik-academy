...
<section>
  <div class="container-fluid">
      <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus"></i>Income</button>
  </div>
<div class="card mt-3">
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item text-danger" href="{{route('backend.income.delete',$categorys->id)}}" onclick="return confirm('Are you sure to delete this data..??')"><i class="fas fa-trash mr-2"></i>Delete</a>
                        @endif
                      </div>
                    </div>
                  </td> 
...
<div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      <form action="{{route('backend.income.store')}}" method="post">
        @csrf
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label><strong>Income Titel*</strong></label>
            <input type="text" class="form-control" name="income_title"  placeholder="Enter title" required>
        </div> 

        <div class="form-group">
            <label><strong>Income Amount*</strong></label>
        ...
        <div class="form-group">
            ...
            <textarea name="note" class="form-control" placeholder="Enter Note" rows="5" required></textarea>    
        </div>
...
<div role="document" class="modal-dialog">
  ...
  <div class="modal-content">
     <form action="{{route('backend.income.update')}}" method="post">
      @csrf
      <div class="modal-header">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        <label><strong>Income Title*</strong></label>
        <input class="form-control" name="income_title" id="update_income_title">
    </div> 
      <div class="form-group">
...
function editbutton(Id){
  ...
  var url ='{{route("backend.income.edit", ":id")}}'
  ...
  $.ajax({
      ...
      success:function(response){
          ...
          $('#update_income_title').val(response.income_title);
